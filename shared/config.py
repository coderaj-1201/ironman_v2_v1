...
class Settings(BaseSettings):
    ...
    AZURE_COSMOS_KEY: SecretStr                              # local dev; prod uses ManagedIdentity
    AZURE_COSMOS_DATABASE: str            = "rag-analytics"
    AZURE_COSMOS_CONTAINER_CHAT: str      = "chat_history"  # partition key: /conversation_id
    AZURE_COSMOS_CONTAINER_FEEDBACK: str  = "feedback"      # partition key: /answer_id
